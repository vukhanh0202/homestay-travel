...
function Favourite(props) {
    ...
    const [apartmentList, setApartmentList] = useState(Apartment.filter(word => word.favourite === true));
    useEffect(() => {
        if (!LogIn) {
    ...
    const search = () => {
        ...
        let arr = Apartment.filter(word => word.favourite === true).slice(0, number);
        setApartmentList(arr);
    }
    const clearFilter = () => {
        setApartmentList( Apartment.filter(word => word.favourite === true));
    }
